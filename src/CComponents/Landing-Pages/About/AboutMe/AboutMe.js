...
import profile from "../../../../srcImages/AEF15E81-69D2-4941-A968-73AEAC9CF0B3.jpg";
  ...
  return (
    <div>
      <Header
        ...
        {...rest}
      />
      <Parallax small filter image={require("../../../../srcImages/MineBackground.JPG")} />
              ...
              <GridItem xs={12} sm={12} md={6}>
                <div className={classes.profile}>
                  ...
                  <div className={classes.name}>
                    <h3 className={classes.title}>Phillip Avila</h3>
